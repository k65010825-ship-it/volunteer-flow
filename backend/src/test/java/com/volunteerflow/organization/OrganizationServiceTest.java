...
class OrganizationServiceTest {
  ...
  void inviteStoresHashAndDuplicateJoinDoesNotConsumeUse() {
    ...
    invite.setId(1L);
    invite.setOrganizationId(100L);
    invite.setDefaultRoleId(30L);
    invite.setCodeHash(OrganizationService.hashInvite("join-secret"));
    invite.setMaxUses(50);
    invite.setUsedCount(0);
    invite.setStatus("ACTIVE");
    invite.setExpiresAt(java.time.LocalDateTime.of(2026, 9, 16, 0, 0));
    ...
    verify(inviteMapper, never())
        .updateById(org.mockito.ArgumentMatchers.<OrganizationInvite>any());
  ...
  void createInviteNeverPersistsRawCode() {
    ...
    memberRole.setId(30L);
    memberRole.setOrganizationId(100L);
  ...
  void cannotDemoteTheLastActiveOwner() {
    ...
    ownerMember.setId(8L);
    ownerMember.setOrganizationId(100L);
    ownerMember.setRoleId(10L);
    ownerMember.setStatus("ACTIVE");
    RbacRole ownerRole = new RbacRole();
    ownerRole.setId(10L);
    ownerRole.setOrganizationId(100L);
    ownerRole.setBuiltInType("OWNER");
    ownerRole.setStatus("ACTIVE");
    RbacRole memberRole = new RbacRole();
    memberRole.setId(30L);
    memberRole.setOrganizationId(100L);
    memberRole.setBuiltInType("MEMBER");
    ...
    assertThatThrownBy(
            () -> service.assignRole(1L, 100L, 8L, new OrganizationService.AssignRoleRequest(30L)))
    ...
    verify(memberMapper, never())
        .updateById(org.mockito.ArgumentMatchers.<OrganizationMember>any());
  }
}
