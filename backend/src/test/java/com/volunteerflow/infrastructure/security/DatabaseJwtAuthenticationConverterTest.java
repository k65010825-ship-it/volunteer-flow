...
class DatabaseJwtAuthenticationConverterTest {
    ...
    private final DatabaseJwtAuthenticationConverter converter = new DatabaseJwtAuthenticationConverter(userMapper);
    ...
    private Jwt jwt(String subject) {
        ...
        return new Jwt("token", now, now.plusSeconds(60), Map.of("alg", "HS256"), Map.of("sub", subject));
    }
